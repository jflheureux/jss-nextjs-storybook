...
* `jss-nextjs-storybook.module.json` contains developer-owned configuration items
  which are created by the JSS Styleguide sample.
* `jss-nextjs-storybook-Content.module.json` contains content items which are
